    ...
    <div className="flex h-full flex-col bg-[#0B1E2B] border-r border-slate-800/80 w-64 select-none">
      ...
      <div className="p-5 pb-4 border-b border-slate-800/80">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#E8913A] to-[#B45309] flex items-center justify-center text-white font-black text-lg shadow-lg shadow-amber-950/40">
